      ...
      <section className={`relative h-screen flex items-center justify-center overflow-hidden bg-primary`}>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-9xl font-serif text-white font-bold tracking-tighter mb-8 italic"
          >
            MORATA
          </motion.h1>
          <motion.p 
            ...
            className="text-white/80 text-xl md:text-2xl font-light leading-relaxed mb-12 max-w-2xl mx-auto"
          >
